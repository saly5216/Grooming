...
# Hardcoded subcategory URLs for Men's Grooming - Group 4 (Shaving & Sun Care)
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/grooming/aftershave/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/shaving-creams-brushes/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/razers/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/trimmers-clippers/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/after-sun/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/self-tanning/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/tanning-lotions-creams/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/sun-protection/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/beard-care/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/grooming-sets/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Grooming Pipeline - Group 4 (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
