...
# Hardcoded subcategory URLs for Men's Grooming - Group 1 (Face Care)
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/men/grooming/face-moisturizers/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/day-night-creams/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/face-serums-treatments/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/face-oils/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/face-masks/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/sheet-masks/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/face-wash-cleansers/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/face-scrubs-exfoliators/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/toners/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/eye-serum-treatments/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/eye-masks/l/",
    "https://www.boutiqaat.com/ar-kw/men/grooming/lip-balm-treatments/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def run(self) -> bool:
        ...
        logger.info("=" * 80)
        logger.info("Starting Men's Grooming Pipeline - Group 1 (Async – Semaphore=3)")
        logger.info("=" * 80)
        try:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/grooming/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        ...
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/grooming/excel-files"
            )
